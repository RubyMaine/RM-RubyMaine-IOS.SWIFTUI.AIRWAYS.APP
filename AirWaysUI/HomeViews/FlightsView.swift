...
struct FlightsView: View {
    @AppStorage("userName") var userName = "RubyMaine"
    ...
    var body: some View {
        NavigationView {
            ScrollView {
                VStack {
                    HStack {
                        Text("Найдите рейсы, которые подходят вам по времени и бюджету")
                    ...
                    HStack {
                        ...
                        Spacer()
                        NavigationLink(destination: Text("Лучший тур")) {
            ...
            .navigationBarItems(leading: Text("С возвращениями \(userName)!")
                                    .font(.custom("Montserrat-Semibold", size: 16))
                                    .foregroundColor(.black)
                                    .padding(.leading, 15),
