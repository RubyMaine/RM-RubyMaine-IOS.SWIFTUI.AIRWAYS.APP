...
struct FlightDetails: View {
    ...
    @State var cabinClass = "Бизнес Класс"
    
    let cabinClassList = ["Бизнес Класс", "Экономный Класс", "Простой Класс Class"]
                        ...
                        VStack {
                            ...
                            HStack {
                                ...
                                Stepper(value: $countPassengers, in: 1...20) {
                                    Text("\(countPassengers) пассажир\(countPassengers==1 ? "" : "ов")")
                                        .foregroundColor(.black)
                                        .font(.custom("Montserrat-Regular", size: 14))
                                }
